...
export default function GetInCategory({ products, setProducts }) {
  ...
  // const electronics = [...new Set(products.map((product) => product.category))];
  // const jewelery = [...new Set(products.map((product) => product.category))];
  // const mens = [...new Set(products.map((product) => product.category))];
  // const womens = [...new Set(products.map((product) => product.category))];
